...
CATALOGO = [
    ...
    ("pib_per_capita_usd",      "NY.GDP.PCAP.CD",      "PIB per cápita",              "USD corrientes"),
    ("inflacion_pct",           "FP.CPI.TOTL.ZG",      "Inflación",                   "% anual"),
    ("tasa_interes_real_pct",   "FR.INR.RINR",         "Tasa de interés real",        "% anual"),
    ...
    ("ied_usd",                 "BX.KLT.DINV.CD.WD",   "Inversión extranjera directa","USD corrientes"),
    ("deuda_externa_usd",       "DT.DOD.DECT.CD",      "Deuda externa",               "USD corrientes"),
    ("poblacion",               "SP.POP.TOTL",         "Población",                   "habitantes"),
    ("gasto_educacion_pct_pib", "SE.XPD.TOTL.GD.ZS",   "Gasto público en educación",  "% del PIB"),
    ("gasto_salud_pct_pib",     "SH.XPD.CHEX.GD.ZS",   "Gasto en salud",              "% del PIB"),
    ("co2_per_capita_ton",      "EN.GHG.CO2.PC.CE.AR5","Emisiones CO₂ per cápita",    "toneladas"),
    ("gini",                    "SI.POV.GINI",         "Índice de Gini",              "0-100"),
]

EVENTOS = [
    (1976, "Devaluación del peso",                    "crisis"),
    ...
    (2000, "Alternancia política: Fox / PAN",         "regimen"),
    (2001, "Recesión EUA post-9/11",                  "externo"),
    (2006, "Inicio periodo de Calderón",              "regimen"),
    (2009, "Crisis financiera global",                "crisis"),
    (2012, "Inicio periodo de Peña Nieto",            "regimen"),
    (2018, "Inicio periodo de López Obrador (AMLO)",  "regimen"),
